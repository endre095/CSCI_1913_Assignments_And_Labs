...
#This function performs a simple calculation to convert degrees F to C
def F_to_C(f_temp):
...
#This function "cleans" a file by determining if any of the values in the below list
#are in the current list, if so it deletes the entire list element
...
#This function determines the average of a certain column of a list
